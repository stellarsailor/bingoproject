                    ...
                    <Row>
                        <Col xs={12} sm={8} md={8} lg={8} xl={8} style={{padding: 8}}>
                            <ResultBox bgColor={'#4285F4'}>
                                ...
                                <BigTextInResultBox>
                                    ...
                                    <span style={{fontSize: 12, marginLeft: 8}}>{t("STATIC_AVG")} : {resultAvgCount.toFixed(2)}</span>
                                </BigTextInResultBox>
                                <MiniTextInResultBox>
                        ...
                        <Col xs={12} sm={8} md={8} lg={8} xl={8} style={{padding: 8}}>
                            <ResultBox bgColor={'#0F9D58'}>
                                ...
                                <BigTextInResultBox>
                                    {completedBingoLines}
                                    <span style={{fontSize: 12, marginLeft: 8}}>{t("STATIC_AVG")} : {resultAvgBingoLines.toFixed(2)}</span>
                                </BigTextInResultBox>
                            </ResultBox>
                        </Col>
                        <Col xs={12} sm={8} md={8} lg={8} xl={8} style={{padding: 8}}>
