...
export default function CreateButtonTab(props) {
  ...
  return (
    ...
    >
      <EachButton
        isSelected={props.selectedButton === 0}
        onClick={() => props.setSelectedButton(0)}
      >
        <InfoCircleOutlined style={{ fontSize: 20 }} />
        Information
      </EachButton>
      <EachButton
        isSelected={props.selectedButton === 1}
        onClick={() => props.setSelectedButton(1)}
      >
        <HighlightOutlined style={{ fontSize: 20 }} />
        Color
      </EachButton>
      <EachButton
        isSelected={props.selectedButton === 2}
        onClick={() => props.setSelectedButton(2)}
      >
        <BgColorsOutlined style={{ fontSize: 20 }} />
        Bkground
      </EachButton>
      <EachButton
        isSelected={props.selectedButton === 3}
        onClick={() => props.setSelectedButton(3)}
      >
        <BarsOutlined style={{ fontSize: 20 }} />
        Edit Bingo
      </EachButton>
      <EachButton
        isSelected={props.selectedButton === 4}
        onClick={() => props.setSelectedButton(4)}
      >
