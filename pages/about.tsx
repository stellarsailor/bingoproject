  ...
  return (
    <>
      <Row style={{ padding: 50, backgroundColor: "white" }}>
        <Col span={24}>
          <CenteredCol>
            <MainText type={1} isMobile={isMobile}>
              PLAY
            </MainText>
            <MainText type={1} isMobile={isMobile}>
              SINGLE
            ...
            <ExplanationText>
              Selfbingo provides various bingos you can play alone. You can
              share the bingo with your friends who have similar interests if
              you want!
            </ExplanationText>
            <Link href="/">
              <a>
                <MainButton size="large" theme="white">
                  {" "}
                  View List{" "}
                </MainButton>
              </a>
        ...
        <Col span={24}>
          <CenteredCol>
            <MainText type={2} isMobile={isMobile}>
              MAKE
            </MainText>
            <MainText type={2} isMobile={isMobile}>
              YOUR
            ...
            <Link href="/bingo/create">
              <a>
                <MainButton type="primary" size="large" theme="black">
                  {" "}
                  Make My Own{" "}
                </MainButton>
              </a>
        ...
        <HrLine />
        <Col span={24}>Contact : selfbingo.com@gmail.com</Col>
      </Row>
    </>
  );
}
...
const MainText = styled.div`
  ...
  background: ${(props) =>
    props.type === 1
      ...
      : props.type === 2
      ? "-webkit-linear-gradient(45deg, #7928CA, #FF0080)"
      : "-webkit-linear-gradient(45deg, #007CF0, #00DFD8)"};
